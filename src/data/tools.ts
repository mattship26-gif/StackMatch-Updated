import { ToolCategory, CompanySize, PricingTier, ToolRating, CaseStudy, Integration, AITool } from './toolCategories';
import { moreTools } from './more-tools';

// Re-export types for other components to use
export type { CompanySize, ToolCategory, PricingTier, ToolRating, CaseStudy, Integration, AITool };
...

{
...

  {
    ...
    integrations: [
      { toolName: 'Everything', integrationType: 'native', complexity: 'complex' }
    ],
    learningCurve: 'steep',
  ...
  // ============================================
  {
    ...
    integrations: [
      { toolName: '60,000+ plugins', integrationType: 'native', complexity: 'complex' }
    ],
    learningCurve: 'easy',
...
// EXPORT
// ============================================
export const toolsData = [...tools, ...moreTools];

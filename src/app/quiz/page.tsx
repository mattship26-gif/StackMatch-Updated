        ...
        <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
              ...
              <div className="space-y-3">
                {[
                  ...
                  >
                    ...
                    <div className="text-sm text-slate-700">{option.desc}</div>
                  </button>
                ))}
              </div>
            </div>
          ...
          <div className="flex justify-between mt-8 pt-6 border-t border-slate-200">
            <button
              onClick={handleBack}
              disabled={step === 1}
              className="px-6 py-2 text-slate-700 hover:text-slate-900 disabled:opacity-30 disabled:cursor-not-allowed"
            >
              ← Back
            </button>
            <button

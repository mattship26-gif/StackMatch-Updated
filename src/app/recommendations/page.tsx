                    ...
                    <div className={`bg-white rounded-xl border-2 p-5 h-full flex flex-col gap-4 transition hover:shadow-lg ${
                      ...
                      <div className="bg-slate-50 rounded-lg px-4 py-3 text-sm">
                        <div className="flex justify-between items-center">
                          <span className="text-slate-600">Est. cost ({teamSize} users)</span>
                          <span className="font-semibold text-slate-900">{cost.label}</span>
                        </div>
                        {cost.notes[0] && (
                          <p className="text-slate-500 text-xs mt-1">{cost.notes[0]}</p>
                        )}
                      </div>
...
export default function RecommendationsPage() {
  return (
    <Suspense fallback={<div className="p-12 text-center text-slate-600">Loading your recommendations...</div>}>

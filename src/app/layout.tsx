...
export const metadata: Metadata = {
  ...
  description:
    'StackMatch is the free, honest guide to 200+ business tools. Find the right stack for your industry, team size, and budget. No affiliate links. No outdated lists.',
};
            ...
            >
              <div>
                ...
                <p style={{ fontSize: 13, color: '#A1A1AA', lineHeight: 1.6 }}>
                  Honest, context-aware tool recommendations. No affiliate links. No paid
                  placements.
                </p>
              </div>
              ...
              <div>
                ...
                {[
                  ...
                  ['/industry/saas-tech', 'SaaS & Tech'],
                  ['/industry', 'View all →'],
                ].map(([href, label]) => (
                  <Link
                    key={href}
                    href={href}
                    className={label === 'View all →' ? 'footer-link-accent' : 'footer-link'}
                    style={{
                      display: 'block',
                      fontSize: 14,
                      color: label === 'View all →' ? '#818CF8' : '#A1A1AA',
                      textDecoration: 'none',
                      marginBottom: 8,
                      transition: 'color 0.15s',
                    }}

        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
                  ...
                  <div className="absolute top-full left-0 right-0 bg-white border border-slate-200 rounded-lg shadow-lg z-10 mt-1">
                    {filteredTools.map(tool => (
                      ...
                      >
                        ...
                        <div className="text-xs text-slate-700">{tool.category}</div>
                      </button>
                    ))}
                  </div>
                )}
            ...
            {selectedTools.length > 0 ? (
              ...
              <div className="bg-white rounded-xl border-2 border-dashed border-slate-300 p-12 text-center">
                ...
                <p className="text-slate-700">Search for tools above to start building your stack</p>
                <p className="text-slate-600 text-sm mt-1">Try: "Salesforce", "Project Management", or "HRIS"</p>
              </div>
            )}
            ...
            {suggestions.length > 0 && (
              <div className="bg-white rounded-xl border border-slate-200 p-6">
                ...
                <p className="text-sm text-slate-700 mb-4">Tools your stack already integrates with</p>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl border border-slate-200 p-6">
              ...
              <p className="text-xs text-slate-700 mt-1">Used for cost estimates</p>
            </div>
...
export default function StackBuilderPage() {
  return (
    <Suspense fallback={<div className="p-12 text-center text-slate-700">Loading stack builder...</div>}>
      <StackBuilderContent />
    </Suspense>
  );
}
